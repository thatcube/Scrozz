...
mod tests {
    ...
    fn frozen_region_output_crops_the_pre_overlay_frame_with_its_stride() {
        ...
        let source = FrozenSource {
            ...
            capture: Capture::new(
                ...
                Provenance::Display,
                CaptureTarget::Display(display.id.clone()),
            ),
        };
    ...
    impl scrozz_core::WindowPicking for RecordingBackend {
        fn window_picking(&self) -> scrozz_core::WindowPickingCapability {
            scrozz_core::WindowPickingCapability::in_process(
                scrozz_core::ShadowSupport::Toggleable,
                false,
            )
        }
    }
