...
impl RecordingPlan {
    pub(crate) fn new(
        ...
        Self {
            ...
            codec,
            bitrate: request.quality.target_bitrate(width, height, request.fps),
...
mod tests {
    ...
    fn recording_plan_keeps_muxer_fragments_and_hardware_safe_dimensions() {
        ...
        request.resolution = RecordingResolution::MaxShortestEdge(1_080);
        request.quality = Quality::High;
        let plan = RecordingPlan::new(&request, 3_840, 2_160, 2.0, false);
