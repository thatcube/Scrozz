...
/// Compatibility exports for downstream code while the Recent Captures
/// domain-specific names replace the former generic overlay API.
#[deprecated(note = "use scrozz_ui::recent_captures_overlay")]
pub mod overlay_app {
    pub use crate::recent_captures_overlay::*;
}
pub use select::{
