...
const WINDOW_SIZE: Vec2 = Vec2::new(780.0, 640.0);
const WINDOW_MIN_SIZE: Vec2 = Vec2::new(620.0, 540.0);
                ...
                egui::Frame::new()
                    ...
                    .show(settings_ui, |ui| {
                        ...
                        match self.pane {
                            ...
                            Pane::Shortcuts => {
                                edits.shortcuts = self.draw_shortcuts(ui, &theme, shortcuts);
                            }
        ...
        ui.horizontal(|ui| {
            ...
            ui.with_layout(Layout::right_to_left(Align::Center), |ui| {
                for (pane, name) in [
                    ...
                    (Pane::AfterCapture, "After Capture"),
                ] {
                    ...
                    let response = ui.add(
                        egui::Button::new(
                            RichText::new(name).font(theme.font(Text::Label)).color(ink),
                        )
                        .fill(fill)
