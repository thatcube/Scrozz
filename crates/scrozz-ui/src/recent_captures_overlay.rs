...
/// Compatibility alias for the pre-domain-boundary public name.
pub type OverlayGeometry = RecentCapturesOverlayGeometry;
/// Compatibility alias for the pre-domain-boundary public name.
pub type OverlayOptions = RecentCapturesOverlayOptions;
/// Compatibility alias for the pre-domain-boundary public name.
pub type OverlayEvent = RecentCapturesOverlayEvent;
/// Compatibility alias for the pre-domain-boundary public name.
pub type OverlayHandle = RecentCapturesOverlayHandle;
/// Compatibility alias for the pre-domain-boundary public name.
pub type OverlayApp = RecentCapturesOverlayApp;
