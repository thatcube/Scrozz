...
use scrozz_store::{
    CaptureSharing, DocumentState, History as _, ImageState, NewCapture, Page, RemoteDeletionState,
    RemoteObjectStatus, SearchQuery, SqliteStore, Store as _, Timestamp,
    test_support::{
