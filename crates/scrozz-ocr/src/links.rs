//! Link classification over recognised text.
...
pub struct Link {
    /// Text as it appeared in the image.
    pub text: String,
    /// Safe target to hand to the operating system after explicit user action.
    pub target: String,
    /// The target family.
    pub kind: LinkKind,
    /// Bounds of the OCR block that contained the link.
    pub bounds: LogicalRect,
    /// Index of the originating OCR block.
...
fn classify(text: &str) -> Option<LinkKind> {
